...
public class KafkaPostMan implements PostMan {
	...
	private final ReactiveKafkaProducerTemplate<String, Envelope<MessageSeen>> kafkaMessagesStatusProducerTemplate;

	public KafkaPostMan(ReactiveKafkaProducerTemplate<String, Envelope<Message>> kafkaProducerTemplate,
						ReactiveKafkaProducerTemplate<String, Envelope<MessageSeen>> kafkaMessagesStatusProducerTemplate) {
	...
	@Override
	public Mono<Void> notifyAboutMsgStatusUpdated(Envelope<MessageSeen> messageSeen) {
